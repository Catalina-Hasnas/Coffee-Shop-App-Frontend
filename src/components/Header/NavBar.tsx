                        ...
                        <div className="flex items-center justify-between h-16 ">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-center space-x-10">
                                    <Link to="/categories/1" className="font-bold tracking-wider text-xl hover:text-secondary"> Coffee </Link>
                                    <Link to="/categories/2" className="font-bold tracking-wider text-xl hover:text-secondary"> Tea </Link>
                                    <Link to="/categories/3" className="font-bold tracking-wider text-xl hover:text-secondary"> Milk </Link>
                                    <Link to="/categories/4" className="font-bold tracking-wider text-xl hover:text-secondary"> Sweeteners </Link>
                                    <Link to="/categories/5" className="font-bold tracking-wider text-xl hover:text-secondary"> Coffee Machines </Link>
                                </div>
                            </div>
                            ...
                            <div className="hidden md:block">
                                <div className="ml-4 flex items-center md:ml-6">
                                    <Link className="relative inline-flex" to="/cart">
                                        ...
                                        <span className="p-2 rounded-full bg-primary text-xs text-primaryLight h-1.5 flex items-center justify-center"  > {props.orderItemsLength ? props.orderItemsLength : null } </span>
